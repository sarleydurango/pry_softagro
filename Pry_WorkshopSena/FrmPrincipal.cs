...
namespace Pry_WorkshopSena
{
    public partial class FrmPrincipal : Form
    {
        ...
        public FrmPrincipal()
        {
            ...
            Func_CargarRol1();
            FuncBuscarNit();
            FuncCargarSolicitudes();
            Func_CargarNumeOrdenImprimir();
        ...
        protected void Func_Registrar()
        {
            ...
            Pnl_InformesGenerales.Visible = false;
        ...
        protected void Func_PanelEmpresa()
        {
            ...
            Pnl_RegistroEmpresa.Size = new Size(1120, 600);
            PnlConfiguracion.Visible = false;
            Pnl_MasOpciones.Visible = false;
            Pnl_Inventario.Visible = false;
            Pnl_Registroinventario.Visible = false;
        ...
        protected void Func_PanelInicio()
        {
            ...
            Pnl_InicioSession.Size = new Size(1120, 600);
        ...
        private void PictureBox8_Click(object sender, EventArgs e)
        {
            ...
            Pnl_Inicio.Size = new Size(900, 525);
        ...
        protected void FuncPanelOrdenTrabajo()
        {
            ...
            Pnl_Registroinventario.Visible = false;
            Pnl_Pagina_En_Diseño.Visible = false;
            Txt_CodInventario_PnlOT.ReadOnly = false;
            TxtValor_PnlOrdenTrabajo.ReadOnly = true;
            TxtNroHoras_PnlOrdenTrabajo.ReadOnly = true;
            TxtReporte_PnlOrdenTrabajo.ReadOnly = true;
        }
        ...
        protected void FuncCargarTecnico()
        {
            Cls_OrdenTrabajo ObjTecnico = new Cls_OrdenTrabajo();
            ObjTecnico.FuncCargarTecnicos();
            CbxTecnico_Encargado_PnlOrdenTrabajo.DataSource = ObjTecnico.dt_Tecnico;
            CbxTecnico_Encargado_PnlOrdenTrabajo.DisplayMember = "Nombre";
            CbxTecnico_Encargado_PnlOrdenTrabajo.ValueMember = "PKId";
        }
        ...
        protected void FuncCargarSolicitudes()
        {
            Cls_OrdenTrabajo ObjSolicitudes = new Cls_OrdenTrabajo();
            //ObjSolicitudes.estado = Cbx_Estado_PnlInicio.SelectedIndex +1;
            ObjSolicitudes.FuncCargarSolicitudes();
            Dtg_Solicitudes.DataSource = ObjSolicitudes.dt_solicitudes;
        }
        ...
        {
            Pnl_InformesGenerales.Visible = true;
            Pnl_InicioSession.Location = new Point(220, 75);
            Pnl_InicioSession.Size = new Size(895, 525);
        ...
        protected void Func_PanelSolicitud()
        {
            Pnl_Registro.Visible = false;
            PNL_OrdenDeTrabajo.Visible = false;
            PnlHojadeVida.Visible = false;
            ...
            Pnl_Inicio.Visible = false;
            Pnl_FrmMiEmpresa.Visible = false;
            Pnl_Solicitudes.Location = new Point(220, 75);
            Pnl_Solicitudes.Size = new Size(893, 525);
            Pnl_Solicitudes.Visible = true;
        }
        protected void FUnc_CargarTipoSolicitud()
        {
            ClsInventario ObjTipo = new ClsInventario();
            ObjTipo.FuncConsultarTipo();
            cbxTipoEquipo.DataSource = ObjTipo.dt_Tipo;
            cbxTipoEquipo.DisplayMember = "Descripcion";
            cbxTipoEquipo.ValueMember = "PKId";
        }

        protected void Func_CargarTipoActividadSolicitud()
        {
            Cls_OrdenTrabajo ObjMantenimiento = new Cls_OrdenTrabajo();
            ObjMantenimiento.Func_CargarMantenimiento();
            cbxTipoActividad.DataSource = ObjMantenimiento.dt_TipoActividad;
            cbxTipoActividad.DisplayMember = "Desacripcion";
            cbxTipoActividad.ValueMember = "PKId";
        }

        protected void FuncNiveldePrioridadSolicitud()
        {
            Cls_OrdenTrabajo ObjPrioridad = new Cls_OrdenTrabajo();
            ObjPrioridad.FuncCargarPrioridad();
            cbxPrioridad.DataSource = ObjPrioridad.dt_NivelPrioridad;
            cbxPrioridad.DisplayMember = "Descripcion";
            cbxPrioridad.ValueMember = "PKId";
        }

        protected void Func_CargarDependecia()
        {
            ClsInventario ObjDepemdencia = new ClsInventario();
            ObjDepemdencia.funcConsultarDependencias();
            cbxDependencia_S.DataSource = ObjDepemdencia.dt_dependencia;
            cbxDependencia_S.DisplayMember = "Descripcion";
            cbxDependencia_S.ValueMember = "PKId";
        }

        protected void FuncCargarN_Solicitud()
        {
            Cls_Solicitudes objsolicitudes = new Cls_Solicitudes();
            objsolicitudes.Func_CargarSolicitud();
            if(objsolicitudes.sw==1)
            {
                LblN_Solicitud_solicitud.Text = objsolicitudes.numeroSolicitud;
            }
        ...
        {
            Func_PanelSolicitud();
            Func_CargarRegionalSolicitud();
            Func_CargarDependenciaSolicitud();
            Func_CargarAmbienteSolicitud();
            FUnc_CargarTipoSolicitud();
            Func_CargarTipoActividadSolicitud();
            FuncNiveldePrioridadSolicitud();
            Func_CargarDependecia();
            FuncCargarN_Solicitud();
        }
        ...
        private void PtbNuevoRegistroMaquina_Click(object sender, EventArgs e)
        {
            ...
            Btn_Actulizar_Ruta3.Visible = false;
            BtnActualizar_Ruta4.Visible = false;
            Txt_CodigoPhotoMaquina.ReadOnly = false;
        }
        ...
        protected void Func_ConsultarRegistroFotografico()
        {
            ...
            if (ObjFoto.sw == 1)
            {
                ...
                Txt_CodigoPhotoMaquina.ReadOnly = true;
            }
        ...
        {
            Cls_OrdenTrabajo ObjN_orden = new Cls_OrdenTrabajo();
            ObjN_orden.Codigo_Maquina = TxtCodigoEquipo_PnlHojadeVida.Text;
            ObjN_orden.Func_CargarNumeOrdenImprimir();
            if(ObjN_orden.sw == 1)
            {
                Lbl_NumeroOrdenTra_hojaM.Text = ObjN_orden.NumeroOr;
            }
        ...
        {
            if ((((Txt_CodInventario_PnlOT.Text == "") || (TxtActividadesEjec_PnlOrdenTrabajo.Text == "") ||   (CbxTecnico_Encargado_PnlOrdenTrabajo.Text == ""))))
            {
            ...
            else
            {
                ...
                ObjordenTrabajo.nombre_tecnico = Convert.ToString(CbxTecnico_Encargado_PnlOrdenTrabajo.SelectedValue);
                ObjordenTrabajo.Valor = TxtValor_PnlOrdenTrabajo.Text;
                ObjordenTrabajo.ambiente = Convert.ToString(Cbx_Ambiente2_PnlOrdenTrabajo.SelectedValue);
                ObjordenTrabajo.dependencia = Convert.ToString(CbxDependencia_PnlOrdenTrabajo.SelectedValue);
                if (Check_Mecanico.Checked == true)
                { ObjordenTrabajo.mecanico = 1; } else { ObjordenTrabajo.mecanico = 0; }
                if (Check_Electrico.Checked == true)
                { ObjordenTrabajo.electrico = 1; } else { ObjordenTrabajo.electrico = 0; }
                if (Check_Hidraulico.Checked == true)
                { ObjordenTrabajo.hidraulco = 1; } else { ObjordenTrabajo.hidraulco = 0; }
                if (Check_Neumatico.Checked == true)
                { ObjordenTrabajo.neumatico = 1; } else { ObjordenTrabajo.neumatico = 0; }
                if (Check_Locativo.Checked == true)
                { ObjordenTrabajo.locativo = 1; } else { ObjordenTrabajo.locativo = 0; }
                if (Check_Electronico.Checked == true)
                { ObjordenTrabajo.electronico = 1; } else { ObjordenTrabajo.electronico = 0; }
                if (Check_OtroSistema.Checked == true)
                { ObjordenTrabajo.otro = 1; } else { ObjordenTrabajo.otro = 0; }
        ...
        protected void Func_CargarNumeOrdenImprimir()
        {
            Cls_OrdenTrabajo objorden = new Cls_OrdenTrabajo();
            objorden.Codigo_Maquina = Txt_CodInventario_PnlOT.Text;
            objorden.Func_CargarNumeOrdenImprimir();
            if(objorden.sw == 1)
            {
                LblN_Imprimir.Text = objorden.NumeroOr;
            }
        }
        ...
        private void Ptb_Actualizar_PnlOT_Click(object sender, EventArgs e)
        {

        }

        private void Ptb_VincularTecnico_PnlOrdenTrabajo_Click(object sender, EventArgs e)
        {
            FrmTecnico ObjTecnico = new FrmTecnico();
            ObjTecnico.Show();
        }

        //protected void Func_CargarEstado_sol()
        //{
        //    Cls_Solicitudes objestado = new Cls_Solicitudes();
        //    objestado.Func_CargarEstado_Sol();
        //    Cbx_Estado_PnlInicio.DataSource = objestado.dt_estado;
        //    Cbx_Estado_PnlInicio.DisplayMember = "Descripcion";
        //    Cbx_Estado_PnlInicio.ValueMember = "PKId";
        //}
        private void Dtg_Solicitudes_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                int fila = Dtg_Solicitudes.CurrentRow.Index;
                if (Convert.ToString(Dtg_Solicitudes.Rows[fila].Cells[8].Value) == "Pendiente")
                {
                    PNL_OrdenDeTrabajo.Visible = true;
                    PNL_OrdenDeTrabajo.Location = new Point(220, 75);
                    PNL_OrdenDeTrabajo.Size = new Size(893, 525);
                    FuncPanelOrdenTrabajo();
                    LblNro_Solicitud.Text = Convert.ToString(Dtg_Solicitudes.Rows[fila].Cells[0].Value);
                    Txt_CodInventario_PnlOT.Text = Convert.ToString(Dtg_Solicitudes.Rows[fila].Cells[1].Value);
                    Txt_CodInventario_PnlOT.ReadOnly = true;
                    Func_CargarAmbiente_OrdenTra();
                    Func_CargarDependencia_OrdenTra();
                    FuncCargarTipoEquipo();
                    FuncCargarMantenimiento();
        ...
        protected void Func_NuevoOrdenTrabajo()
        {
            Txt_CodInventario_PnlOT.Clear();
            TxtActividadesEjec_PnlOrdenTrabajo.Clear();
            TxtReporte_PnlOrdenTrabajo.Clear();
            TxtNroHoras_PnlOrdenTrabajo.Clear();
            TxtValor_PnlOrdenTrabajo.Clear();
            TxtObservacionesInternas_PnlOrdenTrabajo.Clear();
            Txt_CodInventario_PnlOT.Focus();
            Txt_CodInventario_PnlOT.ReadOnly = false;
        }
        private void Ptb_Nuevo_PnlOT_Click(object sender, EventArgs e)
        {
            Func_NuevoOrdenTrabajo();
        }
        ...
        private void PNL_OrdenDeTrabajo_Paint(object sender, PaintEventArgs e)
        {
           
        }

        private void Ptb_Imprimir_Click(object sender, EventArgs e)
        {         
            ...
            if (objorden.sw == 1)
            {
                ...
                Objimprimir.LblNumero.Text = LblN_Imprimir.Text;
                Objimprimir.Show();
            }          
        }
        protected void Func_CargarRegionalSolicitud()
        {
            Cls_OrdenTrabajo ObjRegional = new Cls_OrdenTrabajo();
            ObjRegional.funcCargarRegional();
            cbxCentroRegional.DataSource = ObjRegional.dt_regional;
            cbxCentroRegional.DisplayMember = "Descripcion";
            cbxCentroRegional.ValueMember = "PKId";
        }
        protected void Func_CargarDependenciaSolicitud()
        {
            ClsInventario ObjDepemdencia = new ClsInventario();
            ObjDepemdencia.funcConsultarDependencias();
            CbxDependecia.DataSource = ObjDepemdencia.dt_dependencia;
            CbxDependecia.DisplayMember = "Descripcion";
            CbxDependecia.ValueMember = "PKId";
        }

        protected void Func_CargarAmbienteSolicitud()
        {
            ClsInventario ObjAmbiente = new ClsInventario();
            ObjAmbiente.Func_CargarAmbiente();
            cbxAmbiente.DataSource = ObjAmbiente.dt_ambiente;
            cbxAmbiente.DisplayMember = "Descripcion";
            cbxAmbiente.ValueMember = "PKId";
        }
        ...
        {
            if (cbxTipoActividad.SelectedIndex == 0)
            {
                if (((txtCodigo.Text == "") || (txtDescripcionServicio.Text == "") || (TxtDiagnosticoTecnico.Text == "")))
                {
                    MessageBox.Show("Debe diligenciar todos los datos", "Validacion de Informacion", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
                    Cls_Solicitudes objsolucitudes = new Cls_Solicitudes();
                    objsolucitudes.Regional = Convert.ToString(cbxCentroRegional.SelectedValue);
                    objsolucitudes.Dependencias = Convert.ToString(CbxDependecia.SelectedValue);
                    objsolucitudes.Ambiente = Convert.ToString(cbxAmbiente.SelectedValue);
                    objsolucitudes.Codig_Inven = txtCodigo.Text;
                    objsolucitudes.Tipo = Convert.ToString(cbxTipoEquipo.SelectedValue);
                    objsolucitudes.TipoMto = Convert.ToString(cbxTipoActividad.SelectedValue);
                    objsolucitudes.Nivel = Convert.ToString(CbxNivel.SelectedValue);
                    objsolucitudes.Prioridad = Convert.ToString(cbxPrioridad.SelectedValue);
                    objsolucitudes.Servicio_Solicitado = txtDescripcionServicio.Text;
                    objsolucitudes.Diagnostico_Tecnico = TxtDiagnosticoTecnico.Text;
                    objsolucitudes.Usuario = LblUsuario.Text;
                    if (chec_Mecanico_s.Checked == true)
                    { objsolucitudes.Mecanico = 1; }
                    else { objsolucitudes.Mecanico = 0; }
                    if (chec_Electronico_s.Checked == true)
                    { objsolucitudes.Electronico = 1; }
                    else { objsolucitudes.Electronico = 0; }
                    if (chec_Electrico_s.Checked == true)
                    { objsolucitudes.Electrico = 1; }
                    else { objsolucitudes.Electrico = 0; }
                    if (chec_Neumatico_s.Checked == true)
                    { objsolucitudes.Neumatico = 1; }
                    else { objsolucitudes.Neumatico = 0; }
                    if (chec_Locativo_s.Checked == true)
                    { objsolucitudes.Locativo = 1; }
                    else { objsolucitudes.Locativo = 0; }
                    if (chec_Hidraulico_s.Checked == true)
                    { objsolucitudes.Hidraulico = 1; }
                    else { objsolucitudes.Hidraulico = 0; }
                    if (check_Otro.Checked == true)
                    { objsolucitudes.Otro = 1; }
                    else { objsolucitudes.Otro = 0; }
                    if (check_lubricacion.Checked == true)
                    { objsolucitudes.Lubricacion = 1; }
                    else { objsolucitudes.Lubricacion = 0; }
                    if (chec_Degaste.Checked == true)
                    { objsolucitudes.DesgastePorUso = 1; }
                    else { objsolucitudes.DesgastePorUso = 0; }
                    if (check_MalReparado.Checked == true)
                    { objsolucitudes.Malreparada = 1; }
                    else { objsolucitudes.Malreparada = 0; }
                    if (check_MalOperada.Checked == true)
                    { objsolucitudes.MalOperada = 1; }
                    else { objsolucitudes.MalOperada = 0; }
                    if (check_Accidental.Checked == true)
                    { objsolucitudes.Accidental = 1; }
                    else { objsolucitudes.Accidental = 0; }
                    if (check_Negligencia.Checked == true)
                    { objsolucitudes.Negligencia = 1; }
                    else { objsolucitudes.Negligencia = 0; }
                    if (check_FallaEnEquipo.Checked == true)
                    { objsolucitudes.Falla_OtroEquipo = 1; }
                    else { objsolucitudes.Falla_OtroEquipo = 0; }
                    if (check_SobreCarga.Checked == true)
                    { objsolucitudes.Sobrecarga = 1; }
                    else { objsolucitudes.Sobrecarga = 0; }
                    if (check_RepuestoInadecuados.Checked == true)
                    { objsolucitudes.RepuestosInadecuados = 1; }
                    else { objsolucitudes.RepuestosInadecuados = 0; }
                    if (check_Si_sol.Checked == true)
                    { objsolucitudes.Si = 1; }
                    else { objsolucitudes.Si = 0; }
                    if (check_No_Sol.Checked == true)
                    { objsolucitudes.No = 1; }
                    else { objsolucitudes.No = 0; }
                    objsolucitudes.Func_GenerarSolicitud();
                    MessageBox.Show("Solicitud registrada con exito", "Validacion de Iformacion", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            else
            {
                MessageBox.Show("Las solicitudes solo estan disponibles para mantenimiento correctivos", "Validacion de Iformacion", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
                    

         
        }
        private void Ptb_GuardarSolicitud_Click(object sender, EventArgs e)
        {
        ...
        private void Ptb_SearchCode_Click(object sender, EventArgs e)
        {
            FrmCodigoEquipos objequipos = new FrmCodigoEquipos();
            objequipos.Hide();
        }

        private void Ptb_CodigoEquipo1_Click(object sender, EventArgs e)
        {
            FrmCodigoEquipos objcodigo = new FrmCodigoEquipos();
            objcodigo.Show();
        }
        ...
        private void Ptb_BuscarEquipo_Click(object sender, EventArgs e)
        {
            FrmCodigoEquipos objequipos = new FrmCodigoEquipos();
            objequipos.Show();
        }

        private void Txt_CodigoInventario_KeyUp(object sender, KeyEventArgs e)
        {
            if(e.KeyCode == Keys.Enter)
            { FuncBuscarInventario(); }
        ...
        private void Txt_CodigoPhotoMaquina_KeyUp(object sender, KeyEventArgs e)
        {
            if(e.KeyCode == Keys.Enter)
            {
                FuncCargarNombreMaquina();
        ...
        private void Txt_CodInventario_PnlOT_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsDigit(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void TxtActividadesEjec_PnlOrdenTrabajo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsLetter(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void TxtNroHoras_PnlOrdenTrabajo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsDigit(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void TxtValor_PnlOrdenTrabajo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsDigit(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void TxtObservacionesInternas_PnlOrdenTrabajo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsLetter(e.KeyChar))
            {
                e.Handled = false;
        ...
        {
           OrdenTrabajoRealizada objordenT = new OrdenTrabajoRealizada();
            objordenT.Show();
        }
        ...
        private void TxtDiagnosticoTecnico_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsLetter(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void PNL_OrdenDeTrabajo_Paint_1(object sender, PaintEventArgs e)
        {

        }
        protected void Func_Configuracion()
        {
            Ptb_AddAmbiente.Visible = false;
            PtbAdd_Dependencia.Visible = false;
            lblAgregarAmbiente.Visible = false;
            LblDependencia.Visible = false;
            Ptb_ActualizarEmpresa.Visible = false;
            PtbMi_Empresa.Location = new Point(176, 83);
            PtbMi_Empresa.Size = new Size(128, 128);
            LblMiEmpresa.Location = new Point(191, 214);
            PtbCambiar_contraseña.Location = new Point(388, 83);
            PtbCambiar_contraseña.Size = new Size(128, 128);
            LblCambiarContraseña.Location = new Point(379, 215);
        }
        protected void Func_Rest_Configuracion()
        {
            Ptb_AddAmbiente.Visible = true;
            PtbAdd_Dependencia.Visible = true;
            lblAgregarAmbiente.Visible = true;
            LblDependencia.Visible = true;
            Ptb_ActualizarEmpresa.Visible = true;
            Ptb_AddAmbiente.Location = new Point(176, 83);
            Ptb_AddAmbiente.Size = new Size(128, 128);
            PtbAdd_Dependencia.Location = new Point(388, 83);
            PtbAdd_Dependencia.Size = new Size(128, 128);
            PtbMi_Empresa.Location = new Point(602, 83);
            PtbMi_Empresa.Size = new Size(128, 128);
            PtbCambiar_contraseña.Location = new Point(176, 313);
            PtbCambiar_contraseña.Size = new Size(128, 128);
            LblMiEmpresa.Location = new Point(619, 213);
            LblCambiarContraseña.Location = new Point(162, 443);
        }
        ...
        private void panel10_Click(object sender, EventArgs e)
        {
            ...
            Ptb_ActualizarEmpresa.Visible = false;
            Pnl_FrmMiEmpresa.Location = new Point(220, 75);
            Pnl_FrmMiEmpresa.Size = new Size(892, 525);
            FunBuscarEmpresa();
        }
        ...
        private void Ptb_codigo_maquina_Hoja_Click(object sender, EventArgs e)
        {
            FrmCodigoEquipos objcodigo = new FrmCodigoEquipos();
            objcodigo.Show();
        }
