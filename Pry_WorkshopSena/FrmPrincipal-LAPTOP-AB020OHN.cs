    ...
    public partial class FrmPrincipal : Form
    {
        ...
        private void Dtg_Solicitudes_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                if (Convert.ToString(Dtg_Solicitudes.Rows[fila].Cells[9].Value) == "Pendiente")
                {
                    PNL_OrdenDeTrabajo.Visible = true;
                    PNL_OrdenDeTrabajo.Location = new Point(220, 75);
                    PNL_OrdenDeTrabajo.Size = new Size(893, 525);
        ...
        {
            Pnl_Solicitudes.Location = new Point(220, 73);
            Pnl_Solicitudes.Size = new Size(893, 525);
            Pnl_Solicitudes.Visible = true;
            PNL_OrdenDeTrabajo.Visible = false;
        }

        private void Pnl_Solicitudes_Paint(object sender, PaintEventArgs e)
        {
